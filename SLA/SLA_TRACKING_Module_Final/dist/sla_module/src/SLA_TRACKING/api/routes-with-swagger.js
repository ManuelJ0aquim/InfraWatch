...
async function slaRoutes(app) {
    ...
    }, slaStatus_controller_1.getSlaStatus);
    // Incidents
    ...
    }, incidents_controller_1.listIncidents);
    ...
    }, incidents_controller_1.createIncidentHandler);
    // Maintenance Windows
    ...
    }, maintenance_controller_1.listMaintenances);
    ...
    }, maintenance_controller_1.createMaintenanceHandler);
    // SLA Policies
    ...
    }, policies_controller_1.listPoliciesHandler);
    ...
    }, policies_controller_1.createPolicyHandler);
    // SLA Violations
    ...
    }, violations_controller_1.listViolationsHandler);
}
//# sourceMappingURL=routes-with-swagger.js.map